...
let matrix  (csv:from-file "/Users/victorpena/doctorado/2016/october/netlogo network/experiments/block6c02.csv" ",")
...
;    let half-pairs reduce sentence [ n-values (number-neighbors) [ self ] ] of turtles ;; create a big list where each turtle appears once for each friend it wants to have
...
;;;;;;;;;
  ...
  while [ min [ count my-links + 1 ] of turtles < target-degree ] ;;;; my links + 1
  [ ask links [die]
...
nw:set-context nodes links
 nw:save-graphml "b6c_120_3.graphml"
